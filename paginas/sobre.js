  ...
  return (
    <ScrollView
      ...
      <View style={{flexDirection: 'row'}}>
        <Image source={require('../images/ipvc.png')} style={styles.image} />
        <Image
      ...
      <Text style={styles.title}>
        Aplicação desenvolvida pelos alunos da Licenciatura em Engenharia
        Informática:
      </Text>
      ...
      <Text style={styles.title}>
        Design gráfico efetuado pela aluna do Mestrado de Design do Produto:
      </Text>
      ...
      <Text style={styles.nomes}>David Verde</Text>
      <Text style={styles.nomes}>Hélder Gonçalves</Text>
      <Text style={styles.nomes}>Tânia Silva</Text>

      <View style={styles.espaco}></View>
      <Text style={styles.profs}>Font Awesome Icons</Text>
      <Text style={styles.nomeFontAwesome}>
